...
class BMP280():
    ...
    def get(self):
        ...
        var2 = (((p>>2)) * self.dig_P8)>>13 # NOSONAR
        self.P = p + ((var1 + var2 + self.dig_P7) >> 4)
        return [self.T, self.P]

    # get Temperature in Celsius
    def getTemp(self): #NOSONAR
        self.get()
        return self.T

    # get Pressure in Pa
    def getPress(self): #NOSONAR
        self.get()
        return self.P

    # Calculating absolute altitude
    def	getAltitude(self): #NOSONAR
